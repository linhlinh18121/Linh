            ...
            <div id="layoutSidenav_nav">
             ...
             <?php 
               ...
               include('../config.php');
                ...
                $noi_dung_khoa = mysqli_query($ket_noi, $sql5);
                ...
                $so_luong_khoa = mysqli_num_rows($noi_dung_khoa);
            ;?>
                ...
                <main>
                    <div class="container-fluid px-4">
                        ...
                        <div class="row">
                            ...
                            <div class="col-xl-3 col-md-6">
                                <div class="card bg-primary text-white mb-4">
                                    <div class="card-body">Quản trị Khoa <br>(<?php echo $so_luong_khoa;?>  khoa)</div>
                                    <div class="card-footer d-flex align-items-center justify-content-between">
                                        <a class="small text-white stretched-link" href="quan_tri_khoa.php">Chi tiết</a>
                                        <div class="small text-white"><i class="fas fa-angle-right"></i></div>
                                    </div>
                                </div>
                            </div>
